...
<h3 class="subtitle"><a href="home.html"> Home </a> > <span>LogIn</span></h3>
...
<section id="container" class="container" >
  ...
  <div   class="form-container log-inn">
     ...
     <div class="toggle">
      ...
      <button class="hidden" id="signin">Log In</button>
        </div>
...
<footer class="section-p2">
 ...
 <!--Js to see if password is weak or not -->
 <script>

  var pass1 = document.getElementById("password");
  var msg1 = document.getElementById("wms1");
  var str1 = document.getElementById("strength1");
  ...
  pass1.addEventListener('input', () => {
    ...
    if(pass1.value.length < 4){
      str1.innerHTML = " Weak";
      pass1.style.borderColor = "#ff5925";
      msg1.style.color = "#ff5925"
    }
    else if(pass1.value.length >= 4 && pass1.value.length < 8){
      str1.innerHTML = " Medium";
      pass1.style.borderColor = "#c2dc00";
      msg1.style.color = "#c2dc00"
    }
    else if(pass1.value.length >= 8){
      str1.innerHTML = " Strong";
      pass1.style.borderColor = "#26d730";
      msg1.style.color = "#26d730"
    }
  })
